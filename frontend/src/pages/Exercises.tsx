...
const equipmentList: (Equipment | 'All')[] = ['All', 'Barbell', 'Dumbbell', 'Machine', 'Bodyweight', 'Cable', 'Kettlebell', 'Bands']
...
export default function Exercises() {
  ...
  return (
    <AppShell>
      <PageHeader eyebrow="Library" title="Exercise Library" description="Search and filter every movement in GymAI." />
