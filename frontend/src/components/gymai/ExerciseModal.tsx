  ...
  return (
    <Modal open={open} onClose={onClose} title={exercise.name}>
      ...
      <div className="flex flex-wrap items-center gap-2 mb-4">
        ...
        <Badge variant="neutral">{t(exercise.muscleGroup)}</Badge>
        <Badge variant="neutral">{t(exercise.equipment)}</Badge>
      </div>
      ...
      <div className="mb-5 flex items-center gap-3 rounded-xl border border-surface-border bg-surface-raised p-4">
        ...
        <div><p className="text-sm font-semibold text-ink">{t('Exercise video')}</p><p className="text-xs text-ink-faint">{t('Select a level and watch the exercise demo.')}</p></div>
      </div>
      <div className="grid grid-cols-3 gap-3 mb-5">
        <div className="rounded-xl bg-surface-raised p-3 text-center">
          ...
          <p className="text-[10px] uppercase text-ink-faint">{t('Sets')}</p>
        </div>
        <div className="rounded-xl bg-surface-raised p-3 text-center">
          ...
          <p className="text-[10px] uppercase text-ink-faint">{t('Reps')}</p>
        </div>
        <div className="rounded-xl bg-surface-raised p-3 text-center">
          ...
          <p className="text-[10px] uppercase text-ink-faint">{t('Rest')}</p>
        </div>
      </div>
      <p className="label-eyebrow mb-2">{t('Form cues')}</p>
      ...
      <p className="label-eyebrow mt-5 mb-2">{t('Common mistakes')}</p>
      ...
      {exercise.poseSupported && <div className="mt-5 rounded-xl border border-emerald/20 bg-emerald/[0.06] p-3 text-xs text-ink-muted"><span className="font-semibold text-emerald">{t('Beginner AI form support')}:</span> {t('This movement is prepared for the MediaPipe training flow.')}</div>}
    </Modal>
  )
}
